              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full justify-start"
                    onClick={() => window.location.href = "/test-funcionalidades"}
                  >
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <Button 
                    variant="outline" 
                    className="w-full justify-start"
                    onClick={() => window.location.href = "/acesso/operacional"}
                  >
                    <Shield className="h-4 w-4 mr-2" />
                    Acesso Operacional
                  </Button>
                  <Button 
                    variant="outline" 
                    className="w-full justify-start"
                    onClick={() => window.location.href = "/manutencao"}
                  >
              ...
              <CardContent>
                <div className="space-y-4 text-sm">
                  <div>
                    ...
                    <p>1. Vá para a página principal: <Link href="/" className="text-blue-600 underline">localhost:3000</Link></p>
                  ...
                  <div>
                    ...
                    <p>1. Vá para a página admin: <Link href="/admin" className="text-blue-600 underline">localhost:3000/admin</Link></p>
