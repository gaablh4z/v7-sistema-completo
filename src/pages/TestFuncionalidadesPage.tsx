...
export default function TestFuncionalidadesPage() {
  ...
  const testNavigation = async () => {
    ...
    try {
      ...
      const isValidRoute = currentUrl.includes("localhost:5173") || currentUrl.includes("test-funcionalidades")
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <Button variant="outline" onClick={() => navigate("/acesso/operacional")}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                <strong>Framework:</strong> Vite + React 18
              </div>
              <div>
